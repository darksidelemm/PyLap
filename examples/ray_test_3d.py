...
# %     Modified to make use of multi-threaded raytrace_3d. IRI2020 is now used
...
from pylap.plotting import plot_ray_iono_slice as plot_ray_iono_slice
from pylap.maths import raz2latlon
from pylap.maths import latlon2raz
...
[iono_pf_grid, iono_pf_grid_5, collision_freq, Bx, By, Bz] = \
    gen_iono.gen_iono_grid_3d(UT, R12, iono_grid_parms,
                              geomag_grid_parms, doppler_flag, profile_type='iri2020')  # all within range except collision_freq
