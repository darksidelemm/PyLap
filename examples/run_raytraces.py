...
from pylap.ionosphere import gen_iono_grid_2d as gen_iono_IRI
from pylap.ionosphere import gen_SAMI3_iono_grid_2d as gen_iono
from pylap.plotting import plot_ray_iono_slice as plot_iono
from pylap.plotting import plot_map 
...
for index, row in df.iterrows():
    ...
    folder_directory = EXAMPLES_DIR / 'results' / '{}_{}_{}_{}MHz'.format(tx_label, rx_label, date_utc, frequency_MHz)
    ...
    iono_pf_grid, iono_pf_grid_5, collision_freq, irreg, iono_te_grid = \
        gen_iono_IRI.gen_iono_grid_2d(origin_lat, origin_long, R12, UT, ray_bear,
                ...
                height_step, num_heights, kp, doppler_flag, 'iri2020',
                iri_options)
