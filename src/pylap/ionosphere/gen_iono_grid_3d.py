...
from pylap.maths import iri2016_firi_interp
...
#     %%%%%%%%%%%%%%%%%%%
            ...
            height_range = [ht_min, ht_min + (num_heights - 1) * ht_inc,
                            ht_inc]
            ...
            iri_result = iri2020_pkg.IRI(dt_time, height_range, lat, lon)
            ...
            if doppler_flag:
                ...
                iri_result_5 = iri2020_pkg.IRI(dt_time_5, height_range, lat, lon)
